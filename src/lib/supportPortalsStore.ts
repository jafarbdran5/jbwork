...
export const INITIAL_SUPPORT_PORTALS: SupportPortalItem[] = [
  ...
  // =========================================================================
  // 🛡️ EXPANDED CONTENT PROTECTION, ABUSE & SECURITY PORTALS
  // =========================================================================
  {
    id: 'sp_take_it_down',
    company: 'NCMEC',
    platformName: 'Take It Down (NCMEC)',
    serviceNameAr: 'أداة Take It Down لمنع وتجفيف نشر الصور الخاصة للقاصرين (دون 18 سنة)',
    serviceNameEn: 'Take It Down by NCMEC - Remove Explicit Images of Minors',
    descriptionAr: 'المنظومة الدولية المعتمدة من المركز الوطني للأطفال المفقودين والمستغلين (NCMEC) لتوليد بصمات رقمية (Hashes) مشفرة للصور ومقاطع الفيديو الحساسة لمنع تداولها وإزالتها تلقائياً عبر Meta وTikTok وOnlyFans وغيرها.',
    descriptionEn: 'Official platform to hash and remove intimate explicit images taken under 18 years old from major platforms.',
    category: 'privacy_protection',
    officialUrl: 'https://takeitdown.ncmec.org/',
    isVerifiedOfficial: true,
    contactMethodAr: 'البوابة الرقمية المباشرة لتوليد الهاش التشفيري',
    contactMethodEn: 'Direct Cryptographic Hash Generator Portal',
    isPopular: true,
    sortOrder: 72,
    tags: ['take it down', 'ncmec', 'ابتزاز قاصرين', 'حماية محتوى', 'تجفيف صور', 'خصوصية'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_meta_verified_support',
    company: 'Meta',
    platformName: 'Meta Verified (IG / FB)',
    serviceNameAr: 'بوابة الدعم البشري المباشر لمشتركي Meta Verified',
    serviceNameEn: 'Meta Verified Direct Human Support & Live Chat',
    descriptionAr: 'البوابة الحصرية للتواصل مع فريق الدعم البشري المباشر لشركة Meta لحل مشاكل انتحال الحسابات، سرقة الحسابات، فك القيود الإعلانية، وتوثيق الشارة الزرقاء.',
    descriptionEn: 'Direct live chat and email ticket support for Meta Verified subscribed accounts across Instagram and Facebook.',
    category: 'recovery',
    officialUrl: 'https://accountscenter.meta.com/meta_verified',
    isVerifiedOfficial: true,
    contactMethodAr: 'شات مباشر وتذاكر دعم ذات أولوية عليا',
    contactMethodEn: 'Direct In-App Live Chat & High Priority Tickets',
    isPopular: true,
    sortOrder: 73,
    tags: ['meta', 'meta verified', 'دعم بشري', 'توثيق', 'فيسبوك', 'انستغرام', 'شات مباشر'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_whatsapp_emergency_freeze',
    company: 'Meta',
    platformName: 'WhatsApp',
    serviceNameAr: 'تجميد وتعطيل حساب WhatsApp المسروق فوراً عبر البريد',
    serviceNameEn: 'WhatsApp Stolen Account Instant Deactivation Desk',
    descriptionAr: 'الإجراء الرسمي الطارئ لمراسلة فريق أمان WhatsApp لتعطيل الحساب فوراً عند اختراقه أو سرقة شريحة الهاتف، لمنع المخترق من مراسلة جهات الاتصال أو ابتزازهم.',
    descriptionEn: 'Official emergency email desk to freeze and deactivate compromised WhatsApp accounts immediately.',
    category: 'hacked',
    officialUrl: 'https://faq.whatsapp.com/1131652977717250/',
    isVerifiedOfficial: true,
    contactMethodAr: 'إرسال بريد بعنوان "Lost/Stolen: Please deactivate my account" مع الرقم الدولي',
    contactMethodEn: 'Email support@whatsapp.com with international phone number',
    officialEmail: 'support@whatsapp.com',
    isPopular: true,
    sortOrder: 74,
    tags: ['whatsapp', 'واتساب', 'سرقة واتساب', 'تجميد حساب', 'اختراق واتساب', 'meta'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_whatsapp_ban_appeal',
    company: 'Meta',
    platformName: 'WhatsApp',
    serviceNameAr: 'الطعن في الحظر وفك قيود حساب WhatsApp المحظور',
    serviceNameEn: 'WhatsApp Account Ban Appeal & Review Portal',
    descriptionAr: 'النموذج الرسمي للتواصل مع مسؤولي المظالم وفريق أمان WhatsApp لطلب رفع الحظر العشوائي أو الخاطئ المفروض على الأرقام.',
    descriptionEn: 'Official contact portal and grievance officer to appeal wrongful WhatsApp account suspensions and bans.',
    category: 'recovery',
    officialUrl: 'https://www.whatsapp.com/contact/',
    isVerifiedOfficial: true,
    contactMethodAr: 'بوابة الاتصال بـ WhatsApp والبريد الرسمي',
    contactMethodEn: 'Official WhatsApp Contact Form & Grievance Email',
    officialEmail: 'grievance_officer_wa@support.whatsapp.com',
    sortOrder: 75,
    tags: ['whatsapp', 'فك حظر واتساب', 'حظر رقم', 'واتساب اعمال', 'appeal'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_google_search_remove_explicit',
    company: 'Google',
    platformName: 'Google Search',
    serviceNameAr: 'طلب حذف الصور الحساسة والشخصية المنشورة بدون إذن من نتائج بحث Google',
    serviceNameEn: 'Remove Non-Consensual Explicit Images from Google Search Results',
    descriptionAr: 'البوابة القانونية الرسمية من Google لطلب الحذف السريع لأي صور خاصة، صور حميمية مسربة، أو محتوى تشهيري من الظهور في نتائج محرك البحث.',
    descriptionEn: 'Official Google form to remove personal non-consensual explicit imagery and doxxing records from Google search index.',
    category: 'privacy_protection',
    officialUrl: 'https://support.google.com/websearch/answer/6302812',
    isVerifiedOfficial: true,
    contactMethodAr: 'معالج إزالة المحتوى الشخصي الحساس من Google',
    contactMethodEn: 'Google Search Personal Removal Wizard',
    isPopular: true,
    sortOrder: 76,
    tags: ['google', 'حذف من بحث جوجل', 'ابتزاز', 'تسريب صور', 'خصوصية', 'doxxing'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_x_doxxing_ncii',
    company: 'X Corp',
    platformName: 'X (Twitter)',
    serviceNameAr: 'الإبلاغ عن نشر البيانات الشخصية والابتزاز (Doxxing & Intimate Media) في X',
    serviceNameEn: 'Report Doxxing, Private Information & Intimate Media on X',
    descriptionAr: 'النموذج الرسمي المخصص للإزالة الفورية لتغريدات التشهير، أرقام الهواتف المسربة، الوثائق الرسمية، أو الصور الخاصة المنشورة بدون موافقة.',
    descriptionEn: 'Official X/Twitter webform to takedown doxxing tweets, leaked private documents, and non-consensual intimate media.',
    category: 'privacy_protection',
    officialUrl: 'https://help.x.com/en/forms/safety-and-sensitive-content/private-information',
    isVerifiedOfficial: true,
    contactMethodAr: 'نموذج الإبلاغ عن المعلومات الخاصة في X',
    contactMethodEn: 'X Safety & Sensitive Content Intake Form',
    officialEmail: 'privacy@x.com',
    isPopular: true,
    sortOrder: 77,
    tags: ['x', 'twitter', 'تويتر', 'تشهير', 'تسريب بيانات', 'ابتزاز', 'doxxing'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_tiktok_underage_report',
    company: 'TikTok',
    platformName: 'TikTok',
    serviceNameAr: 'الإبلاغ عن حسابات الأطفال القاصرين وإزالتها من TikTok',
    serviceNameEn: 'Report Underage Account on TikTok (Under 13)',
    descriptionAr: 'البوابة المخصصة لأولياء الأمور والمستخدمين لإغلاق وحذف حسابات الأطفال دون سن 13 عاماً حماية لخصوصيتهم وسلامتهم الرقمية.',
    descriptionEn: 'Official form for parents and guardians to report and remove underage TikTok accounts.',
    category: 'content_removal',
    officialUrl: 'https://www.tiktok.com/legal/report/underage',
    isVerifiedOfficial: true,
    contactMethodAr: 'نموذج أمان القاصرين في تيك توك',
    contactMethodEn: 'TikTok Underage Safety Form',
    officialEmail: 'privacy@tiktok.com',
    sortOrder: 78,
    tags: ['tiktok', 'تيك توك', 'أطفال', 'قاصرين', 'حذف حساب', 'سلامة رقمية'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_apple_phishing_report',
    company: 'Apple',
    platformName: 'Apple / iCloud',
    serviceNameAr: 'مكتب الإبلاغ عن التصيد والاحتيال وانتحال شركة Apple',
    serviceNameEn: 'Apple Phishing & Security Threats Intake',
    descriptionAr: 'البريد الرسمي المعتمد من Apple لاستقبال رسائل SMS الاحتيالية ومواقع التصيد التي تحاول سرقة بيانات Apple ID ورموز الدخول.',
    descriptionEn: 'Official Apple security email desk to report phishing SMS, fraudulent emails, and fake iCloud login sites.',
    category: 'safety',
    officialUrl: 'https://support.apple.com/en-us/102568',
    isVerifiedOfficial: true,
    contactMethodAr: 'إعادة توجيه الرسالة المشبوهة إلى reportphishing@apple.com',
    contactMethodEn: 'Forward phishing messages to reportphishing@apple.com',
    officialEmail: 'reportphishing@apple.com',
    sortOrder: 79,
    tags: ['apple', 'ابل', 'تصيد', 'احتيال', 'icloud', 'phishing', 'امان'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    ...
    platformName: 'VirusTotal (Google Chronicle)',
    serviceNameAr: 'أداة VirusTotal لفحص الملفات والروابط والبرمجيات الخبيثة بـ 70+ مضاد فيروسات',
    serviceNameEn: 'VirusTotal - Multi-Engine URL & Malware Scanner',
    descriptionAr: 'المنصة العالمية الأقوى لتحليل الروابط المشبوهة وفحص الملفات والـ APK والتأكد من خلوها من برمجيات التجسس وأحصنة طروادة.',
    descriptionEn: 'The leading threat intelligence platform analyzing suspicious files and URLs across 70+ antivirus engines.',
    category: 'infosec_tools',
    officialUrl: 'https://www.virustotal.com',
    isVerifiedOfficial: true,
    contactMethodAr: 'بوابة الفحص السحابي المباشر',
    contactMethodEn: 'Cloud Threat Intelligence Scanner',
    isPopular: true,
    sortOrder: 80,
    tags: ['virustotal', 'فايروس توتال', 'فحص روابط', 'كشف تجسس', 'malware', 'antivirus'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_infosec_anyrun',
    company: 'Security Tools',
    platformName: 'ANY.RUN Interactive Sandbox',
    serviceNameAr: 'بيئة ANY.RUN التفاعلية لتشغيل واختبار الروابط والملفات الخبيثة بأمان',
    serviceNameEn: 'ANY.RUN Interactive Malware Hunting Sandbox',
    descriptionAr: 'بيئة افتراضية متقدمة تتيح للمحققين الجنائيين فتح الروابط المشبوهة وتحليل سلوكها فوراً دون تعريض أجهزة المحققين لأي خطر.',
    descriptionEn: 'Interactive online sandbox to safely execute and investigate live malware and phishing pages in real-time.',
    category: 'infosec_tools',
    officialUrl: 'https://any.run',
    isVerifiedOfficial: true,
    contactMethodAr: 'منصة الساندبوكس التفاعلي',
    contactMethodEn: 'Interactive Live Sandbox Console',
    sortOrder: 81,
    tags: ['anyrun', 'ساندبوكس', 'تحقيق جنائي', 'فحص رابط', 'sandbox', 'malware analysis'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // 🛡️ TAKE IT DOWN (NCMEC) - مكافحة ابتزاز القاصرين وحذف الصور
  // =========================================================================
  {
    id: 'sp_take_it_down_ncmec',
    company: 'NCMEC',
    platformName: 'Take It Down (NCMEC)',
    serviceNameAr: 'منصة Take It Down الدولية لسحب وتجفيف الصور الحساسة للقاصرين من الإنترنت',
    serviceNameEn: 'Take It Down by NCMEC - Remove & Prevent Youth Explicit Imagery',
    descriptionAr: 'المنصة العالمية المجانية والسرية المعتمدة من المركز الوطني للأطفال المفقودين والمستغلين (NCMEC) لتوليد بصمات رقمية (Hashes) لمنع نشر وحذف الصور الشخصية والحميمية للقاصرين والشباب من كافة منصات التواصل الاجتماعي.',
    descriptionEn: 'Official global service to help remove and prevent the online spread of explicit images taken by or of individuals under 18.',
    category: 'privacy_protection',
    officialUrl: 'https://takeitdown.ncmec.org',
    isVerifiedOfficial: true,
    contactMethodAr: 'توليد بصمة تشفير سرية مباشرة من جهاز الضحية',
    contactMethodEn: 'Anonymous Client-side Direct Hash Generation',
    isPopular: true,
    sortOrder: 82,
    tags: ['take it down', 'ncmec', 'ابتزاز قاصرين', 'حماية اطفال', 'حذف صور', 'stopncii', 'حماية'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // 🤖 OPENAI & ANTHROPIC (منصات الذكاء الاصطناعي والأمان)
  // =========================================================================
  {
    id: 'sp_openai_privacy_safety',
    company: 'OpenAI',
    platformName: 'ChatGPT / OpenAI',
    serviceNameAr: 'بوابة خصوصية وإزالة البيانات الشخصية من نماذج OpenAI و ChatGPT',
    serviceNameEn: 'OpenAI Privacy Request & Personal Data Removal Portal',
    descriptionAr: 'النموذج الرسمي لطلب مسح وتعديل البيانات الشخصية المسربة أو التشهيرية ومنع تدريب نماذج ChatGPT على بيانات العميل الخاصة.',
    descriptionEn: 'Official OpenAI webform to request removal of personal information and opt-out of data training.',
    category: 'ai_tools',
    officialUrl: 'https://privacy.openai.com/policies',
    isVerifiedOfficial: true,
    contactMethodAr: 'بوابة إدارة الخصوصية الرسمية من OpenAI',
    contactMethodEn: 'OpenAI Privacy & Safety Intake Desk',
    officialEmail: 'privacy@openai.com',
    sortOrder: 83,
    tags: ['openai', 'chatgpt', 'ذكاء اصطناعي', 'حذف بيانات', 'خصوصية', 'ai privacy'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_anthropic_claude_safety',
    company: 'OpenAI',
    platformName: 'Anthropic Claude',
    serviceNameAr: 'مكتب أمان المستخدمين والخصوصية في منصة Claude (Anthropic)',
    serviceNameEn: 'Anthropic Claude User Safety & Trust Desk',
    descriptionAr: 'القناة الرسمية للإبلاغ عن إساءة استخدام نماذج Claude في توليد محتوى احتيالي، برمجيات خبيثة، أو انتهاك الخصوصية.',
    descriptionEn: 'Official contact for reporting misuse, automated scams, or privacy violations concerning Claude AI models.',
    category: 'ai_tools',
    officialUrl: 'https://www.anthropic.com/contact-sales',
    isVerifiedOfficial: true,
    contactMethodAr: 'البريد الرسمي لفريق أمان المستخدمين',
    contactMethodEn: 'Direct Safety Email to usersafety@anthropic.com',
    officialEmail: 'usersafety@anthropic.com',
    sortOrder: 84,
    tags: ['anthropic', 'claude', 'ذكاء اصطناعي', 'أمان الذكاء الاصطناعي', 'ai safety'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // 📱 APPLE (إلغاء قفل التنشيط واسترداد Apple ID)
  // =========================================================================
  {
    id: 'sp_apple_activation_lock_removal',
    company: 'Apple',
    platformName: 'Apple Support',
    serviceNameAr: 'طلب فك وإزالة قفل التنشيط الرسمي (Activation Lock Removal) من Apple',
    serviceNameEn: 'Official Apple Activation Lock Support & Proof of Purchase Request',
    descriptionAr: 'البوابة المعتمدة لتقديم إثبات الشراء والفاتورة الرسمية لشركة Apple لفك قفل iCloud Activation Lock للأجهزة المقفلة بعد فقدان البريد أو وفاة المالك أو النزاعات التجارية.',
    descriptionEn: 'Official Apple self-service portal to request the removal of Activation Lock with valid proof of purchase documentation.',
    category: 'phone_hardware',
    officialUrl: 'https://al-support.apple.com/#/additional-support',
    isVerifiedOfficial: true,
    contactMethodAr: 'بوابة دعم قفل التنشيط المباشرة من Apple',
    contactMethodEn: 'Apple Activation Lock Intake Portal',
    isPopular: true,
    sortOrder: 85,
    tags: ['apple', 'ابل', 'ايكلود', 'قفل التنشيط', 'activation lock', 'ايفون', 'icloud lock', 'فتح ايفون'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_apple_iforgot_recovery',
    company: 'Apple',
    platformName: 'Apple ID (iForgot)',
    serviceNameAr: 'استرداد حساب Apple ID وإعادة ضبط كلمة السر ورموز الأمان (iforgot.apple.com)',
    serviceNameEn: 'Apple ID Official Account Recovery Portal',
    descriptionAr: 'البوابة الرسمية الوحيدة لفك قفل حسابات Apple ID الموقوفة لأسباب أمنية، وبدء فترة استرداد الحساب Account Recovery عند فقدان الأجهزة الموثوقة.',
    descriptionEn: 'The primary official portal to recover locked or lost Apple IDs and manage two-factor authentication.',
    category: 'recovery',
    officialUrl: 'https://iforgot.apple.com',
    isVerifiedOfficial: true,
    contactMethodAr: 'معالج استرداد Apple ID المشفر',
    contactMethodEn: 'Apple iforgot Recovery Wizard',
    isPopular: true,
    sortOrder: 86,
    tags: ['apple', 'apple id', 'iforgot', 'ابل', 'استرداد حساب ابل', 'كلمة سر ابل', 'توثيق ثنائي'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // 📱 SAMSUNG & XIAOMI & HUAWEI (استرداد وحماية أجهزة أندرويد)
  // =========================================================================
  {
    id: 'sp_samsung_smartthings_find',
    company: 'Samsung',
    platformName: 'Samsung SmartThings Find',
    serviceNameAr: 'تتبع وتأمين وقفل أجهزة Samsung المسروقة عن بعد (SmartThings Find)',
    serviceNameEn: 'Samsung SmartThings Find / Remote Lock & Wipe',
    descriptionAr: 'لوحة التحكم السحابية الرسمية لتحديد موقع أجهزة سامسونج المفقودة، قفلها بكلمة مرور مخصصة، منع إيقاف تشغيلها، ومسح بياناتها لمنع الوصول للصور والمحادثات.',
    descriptionEn: 'Official cloud console to locate, lock, and remotely wipe compromised or stolen Samsung Galaxy devices.',
    category: 'phone_hardware',
    officialUrl: 'https://smartthingsfind.samsung.com',
    isVerifiedOfficial: true,
    contactMethodAr: 'لوحة التحكم السحابية لسامسونج',
    contactMethodEn: 'Samsung Cloud Security Dashboard',
    isPopular: true,
    sortOrder: 87,
    tags: ['samsung', 'سامسونج', 'تتبع هاتف', 'قفل سامسونج', 'smartthings', 'جالكسي', 'سرقة هاتف'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_xiaomi_cloud_unlock',
    company: 'Xiaomi',
    platformName: 'Xiaomi Cloud (Mi Account)',
    serviceNameAr: 'استرداد وفك قفل حساب Xiaomi و Mi Cloud للأجهزة المقفلة',
    serviceNameEn: 'Xiaomi Mi Account Password Reset & Unlock Service',
    descriptionAr: 'البوابة الرسمية لإعادة تعيين كلمة مرور حساب Mi، فك ارتباط الأجهزة، وتخطي قفل الحماية للأجهزة المقفلة برقم حساب غير متاح.',
    descriptionEn: 'Official Xiaomi portal for resetting Mi Account credentials and unlocking connected devices.',
    category: 'phone_hardware',
    officialUrl: 'https://i.mi.com',
    isVerifiedOfficial: true,
    contactMethodAr: 'بوابة سحابة Xiaomi الرسمية',
    contactMethodEn: 'Xiaomi Cloud Web Portal',
    officialEmail: 'service.global@xiaomi.com',
    sortOrder: 88,
    tags: ['xiaomi', 'شاومي', 'mi cloud', 'حساب شاومي', 'فتح شاومي', 'mi account'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // 💬 TELEGRAM & DISCORD (قنوات الدعم الأمني وحذف المحتوى)
  // =========================================================================
  {
    id: 'sp_telegram_scam_fake_dispute',
    company: 'Telegram',
    platformName: 'Telegram',
    serviceNameAr: 'الإبلاغ عن القنوات الاحتيالية وطلب إزالة علامة Fake/Scam من قنوات Telegram',
    serviceNameEn: 'Telegram Anti-Scam & Channel Verification Desk',
    descriptionAr: 'البوابة الرسمية عبر البوت المعتمد @notoscam لمكافحة القنوات الاحتيالية، أو الطعن في وضع علامات Scam الخاطئة على القنوات والمجموعات الرسمية.',
    descriptionEn: 'Official Telegram anti-scam desk via @notoscam bot to report scams or dispute wrongful scam tags.',
    category: 'safety',
    officialUrl: 'https://t.me/notoscam',
    isVerifiedOfficial: true,
    contactMethodAr: 'التواصل المباشر مع بوت الأمان @notoscam داخل تطبيق Telegram',
    contactMethodEn: 'Official in-app Telegram bot @notoscam',
    officialEmail: 'abuse@telegram.org',
    sortOrder: 89,
    tags: ['telegram', 'تيليجرام', 'احتيال', 'قناة مزيفة', 'notoscam', 'fake tag', 'scam'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_discord_safety_intake',
    company: 'Discord',
    platformName: 'Discord',
    serviceNameAr: 'بوابة تقديم البلاغات العاجلة وحماية الخصوصية وإسقاط خوادم الابتزاز في Discord',
    serviceNameEn: 'Discord Trust & Safety / Harassment & Privacy Web Intake',
    descriptionAr: 'البوابة الرسمية لفريق Trust & Safety لإغلاق خوادم التسريبات، الإبلاغ عن الابتزاز، واسترداد حسابات المشرفين المقفلة.',
    descriptionEn: 'Official web intake portal to report harassment, server raids, and extortion directly to Discord Trust & Safety.',
    category: 'safety',
    officialUrl: 'https://support.discord.com/hc/en-us/requests/new?ticket_form_id=360000029753',
    isVerifiedOfficial: true,
    contactMethodAr: 'نموذج تذاكر Trust & Safety الرسمي',
    contactMethodEn: 'Discord Trust & Safety Ticket System',
    officialEmail: 'abuse@discord.com',
    sortOrder: 90,
    tags: ['discord', 'ديسكورد', 'ابتزاز ديسكورد', 'سيرفر تسريبات', 'trust and safety', 'إسقاط سيرفر'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // ☁️ CLOUDFLARE & HOSTING ABUSE (إسقاط المواقع الاحتيالية والنطاقات)
  // =========================================================================
  {
    id: 'sp_cloudflare_abuse_portal',
    company: 'Cloudflare',
    platformName: 'Cloudflare Abuse Portal',
    serviceNameAr: 'بوابة Cloudflare الرسمية للإبلاغ عن مواقع التصيد والبرمجيات الخبيثة وانتهاك DMCA',
    serviceNameEn: 'Cloudflare Official Abuse Report Portal (Phishing, Malware, DMCA)',
    descriptionAr: 'النموذج الرسمي لإخطار Cloudflare بوجود موقع تصيد أو ابتزاز خلف شبكتها، ما يؤدي لكشف خادم الاستضافة الحقيقي (Origin IP) أو تعليق خدمة الوساطة فوراً.',
    descriptionEn: 'Official web portal to submit abuse reports for sites utilizing Cloudflare CDN and reverse proxy services.',
    category: 'hosting_dns',
    officialUrl: 'https://abuse.cloudflare.com',
    isVerifiedOfficial: true,
    contactMethodAr: 'نموذج الإبلاغ الآلي المباشر عبر abuse.cloudflare.com',
    contactMethodEn: 'Official Cloudflare Abuse Intake System',
    officialEmail: 'abuse@cloudflare.com',
    isPopular: true,
    sortOrder: 91,
    tags: ['cloudflare', 'كلاودفلير', 'إسقاط موقع', 'تصيد', 'phishing', 'dmca', 'abuse', 'استضافة'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_namecheap_abuse_desk',
    company: 'Namecheap',
    platformName: 'Namecheap Legal & Abuse',
    serviceNameAr: 'مكتب تعليق النطاقات الاحتيالية وحذف المواقع الخبيثة في Namecheap',
    serviceNameEn: 'Namecheap Domain Suspension & Abuse Submission Portal',
    descriptionAr: 'البوابة القانونية الرسمية لتقديم شكاوى الاحتيال والتصيد لتعليق أسماء النطاقات (Domain Suspension) المسجلة عبر شركة Namecheap.',
    descriptionEn: 'Official Namecheap portal to report phishing domains, fraudulent stores, and abuse for registrar-level suspension.',
    category: 'hosting_dns',
    officialUrl: 'https://support.namecheap.com/index.php?/Tickets/Submit/RenderForm/25',
    isVerifiedOfficial: true,
    contactMethodAr: 'بوابة تذاكر Abuse الرسمية',
    contactMethodEn: 'Namecheap Abuse Ticket Form',
    officialEmail: 'abuse@namecheap.com',
    sortOrder: 92,
    tags: ['namecheap', 'نيم شيب', 'تعليق دومين', 'نطاق احتيالي', 'domain abuse', 'حذف موقع'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  // =========================================================================
  // 💳 BINANCE & PAYPAL (تجميد الأموال المسروقة ومكافحة الاحتيال المالي)
  // =========================================================================
  {
    id: 'sp_binance_law_enforcement',
    company: 'Binance',
    platformName: 'Binance Law Enforcement & Stolen Funds',
    serviceNameAr: 'بوابة Binance للجهات القضائية وتجميد المحافظ والعملات الرقمية المسروقة',
    serviceNameEn: 'Binance Law Enforcement Portal & Stolen Crypto Emergency Freeze',
    descriptionAr: 'البوابة المخصصة للمحققين وممثلي الضحايا والجهات القانونية لتقديم بلاغات اختراق محافظ العملات الرقمية وتجميد الأصول المسروقة المحولة لمنصة Binance.',
    descriptionEn: 'Official portal for law enforcement and legal representatives to request emergency asset freezes and trace stolen funds on Binance.',
    category: 'finance_crypto',
    officialUrl: 'https://www.binance.com/en/support/faq/how-to-submit-a-law-enforcement-request-on-binance-7d9cf1bfafe74744837568019379fa45',
    isVerifiedOfficial: true,
    contactMethodAr: 'نظام Kodak Law Enforcement الخاص بـ Binance',
    contactMethodEn: 'Binance Kodak Law Enforcement Portal',
    officialEmail: 'support@binance.com',
    isPopular: true,
    sortOrder: 93,
    tags: ['binance', 'بينانس', 'كريبتو', 'عملات رقمية', 'تجميد اموال', 'سرقة محفظة', 'crypto theft'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  },
  {
    id: 'sp_paypal_unauthorized_dispute',
    company: 'PayPal',
    platformName: 'PayPal Resolution Center',
    serviceNameAr: 'مركز حل النزاعات واسترداد الأموال للعمليات غير المصرح بها في PayPal',
    serviceNameEn: 'PayPal Unauthorized Transaction & Resolution Center',
    descriptionAr: 'البوابة الرسمية لفتح نزاع مالي (Unauthorized Transaction) لاسترجاع الأموال المسحوبة أو المحولة بعد اختراق حساب PayPal أو البطاقات البنكية المرتبطة.',
    descriptionEn: 'Official portal to dispute unauthorized payments and freeze fraudulent charges.',
    category: 'finance_crypto',
    officialUrl: 'https://www.paypal.com/disputes/',
    isVerifiedOfficial: true,
    contactMethodAr: 'مركز حل النزاعات الرسمي من PayPal',
    contactMethodEn: 'PayPal Resolution Center Console',
    officialEmail: 'unauthorized@paypal.com',
    sortOrder: 94,
    tags: ['paypal', 'باي بال', 'استرداد اموال', 'عملية غير مصرح بها', 'نزاع مالي', 'dispute'],
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z'
  }
];
